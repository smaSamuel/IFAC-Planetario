<?php
    ...
    class Monitor extends Usuario {
        ...
        public function __destruct() {
            echo 'Objeto DESTRUIDO com SUCESSO!';
        ...
        //Metodo SetIdade()
        public function SetIdade($dataNascimento) {
        ...
        public function SetDiasLivres($diasLivres) { // ** INCOMPLETO **
            $this->_diasLivres = $diasLivres; // Temporario
